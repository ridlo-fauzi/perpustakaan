                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown" >
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="{{ route('buku.buku') }}">Data Buku</a></li>
                            <li><i class="fa fa-puzzle-piece"></i><a href="{{ route('kategori.kategori') }}">Kategori</a></li>
                            <li><i class="fa fa-puzzle-piece"></i><a href="{{ route('penerbit.penerbit') }}">Penerbit</a></li>
                            <li><i class="fa fa-puzzle-piece"></i><a href="{{ route('penulis.penulis') }}">Penulis</a></li>
                            <li><i class="fa fa-puzzle-piece"></i><a href="{{ route('rak.rak') }}">Rak</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
